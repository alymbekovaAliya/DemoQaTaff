...
public class WebElementActions {
    ...
    public WebElementActions selectByText(WebElement element, String text) {
        ...
        return this;
        //если используется тег селект
    }

    public WebElementActions selectedByIndex(WebElement element, int index) {
        select = new Select(element);
        select.selectByIndex(index);
        return this;
    }

    public WebElementActions selectedByValue(WebElement element, String value) {
        select = new Select(element);
    ...
    public WebElementActions rightClick(WebElement element) {
        actions.contextClick(element).perform(); //клик правой кнокпкой мыши
        return this;
    }

    //как драйвер , но работает напрямую c html
    //
    public WebElementActions jsClick(WebElement element) {
        js.executeScript("arguments[0].click();", element); // пофигу на рекламу кликает напрямую через html
        return this;
    }

    public WebElementActions jsHighLightElement(WebElement element) {
